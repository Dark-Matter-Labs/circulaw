...
// can we write one query with arguments fot all themas and product chains?

export const bioMassaQuery = ` 
*[_type == "transitionAgenda" && pcName== "Biomassa en voedsel"][0] {
  ...,
...
export const bioMassaInstrumentCountQuery = ` 
count(*[_type == "measure" && transitionAgenda== "biomassa-en-voedsel"])
`;

export const bioMassaThemaQuery = ` 
*[_type == "thema" && transitionAgenda== "biomassa-en-voedsel"] {
  ...,
  "heroImage": heroImage.asset->.url,
  "heroImageMobile": heroImageMobile.asset->.url,
  "count": count(*[_type == "measure" && thema == slug.current]),
}
`;
