...
// TODO - this is only being used in AboutPage.slug so can remove it from there and delete this query.
// need to replace it with another query or add it to existing.
export const aboutPageSlugsQuery = `
    *[_type == "siteConfig"][]{
