...
export const plasticInDeBouwQueries = {
  plasticLength: `
  count(*[_type == "measure" && thema == "plastic-in-de-bouw"])
  `,
  plasticThemaQuery: `
  *[_type == "simpleThema" && themaName == "Plastic in de bouw"][0]{
    ...,
    "heroImage": heroImage.asset->.url,
    "heroImageMobile": heroImageMobile.asset->.url,
  }
  `,
  plasticInstrumentsQuery: `
  *[_type == "measure" && thema == "plastic-in-de-bouw"]| order(lower(titel) asc) {
    _id,
    titel,
    slug,
    thema,
