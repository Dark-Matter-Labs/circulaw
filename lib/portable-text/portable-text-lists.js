export const bulletComponent = ({ children }) => (
  <div className='newlineDisplay p-base sm:p-lg -mt-6 mb-6'>
    <ul className='list-disc pl-6 p-base sm:p-lg'>{children}</ul>
  </div>
);

export const bulletComponentGreyBox = ({ children }) => (
  <div className='newlineDisplay p-base sm:p-lg -mt-4 mb-4'>
    <ul className='list-disc pl-6 p-base sm:p-lg'>{children}</ul>
  </div>
);

export const numberComponent = ({ children }) => (
  <div className='newlineDisplay p-base sm:p-lg -mt-6 pb-6'>
