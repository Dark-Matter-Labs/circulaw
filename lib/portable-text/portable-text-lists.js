...
export const bulletItemComponent = ({ children }) => <li className='py-0.5 p-base sm:p-lg'>{children}</li>;

export const numberItemComponent = ({ children }) => <li className='py-0.5 p-base sm:p-lg'>{children}</li>;
