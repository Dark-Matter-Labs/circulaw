export const h1Component = ({ children }) => <h1 className='mb-4 heading-2xl-semibold sm:heading-5xl-semibold'>{children}</h1>;
...
export const subheading = ({ children }) => (
  <h2 className='mt-10 -mb-4 heading-xl-semibold sm:p-6xl-bold'>{children}</h2>
);
