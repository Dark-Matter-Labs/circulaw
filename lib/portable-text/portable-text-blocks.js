...
export const h2Component = ({ children }) => (
  <h2 className='mt-8 mb-4 mobile sm:desktop'>{children}</h2>
);

export const h3Component = ({ children }) => (
  <h3 className='mt-8 mb-4 mobile sm:desktop'>{children}</h3>
);
...
export const normalTextComponentSmallPara = ({ children }) => (
  <p className='newlineDisplay text-grey-600 p-sm sm:p-base py-2'>{children}</p>
);
