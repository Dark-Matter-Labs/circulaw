  ...
  return (
    <div className=''>
      <div className='rounded-clSm bg-green-500'>
        <div className='gradient-pdf relative my-10 overflow-hidden rounded-clSm p-10 z-0'>
          <div className='rotate-50 invisible absolute -bottom-32 -right-12 h-96 w-96 md:visible -z-10'>
