  ...
  return (
    <div className='my-6'>
      <Disclosure className='w-full'>
          <>
            <DisclosureButton
              className='text-gray-800 bg-gray-200 flex justify-between items-center w-full px-8 py-6 group data-[open]:rounded-t-clSm rounded-clSm'
            >
              <h4 className='p-base-semibold sm:headling-xl-semibold text-left'>
                {value.greenBoxTitle}
              </h4>
              <FiChevronDown
                className='h-6 w-6 text-gray-800 group-data-[open]:rotate-180'
              />
            </DisclosureButton>
...
export const dropDownComponent = ({ value }) => (
  <>
    <Disclosure>
      {({ open }) => (
        <>
          <DisclosureButton className='text-black hover:text-green-500 justify-between items-center inline-flex'>
