  ...
  return (
    <div className='my-6'>
      <Disclosure className='w-full'>
        <>
          <DisclosureButton className='group flex w-full items-center justify-between rounded-clSm bg-green-100 px-8 py-6 text-cl-black data-[open]:rounded-t-clSm'>
...
export const smallParaPTComponent = ({ value }) => {
  ...
  return (
    <div className='my-6'>
      <div className='w-full rounded-clSm bg-green-100 text-cl-black'>
