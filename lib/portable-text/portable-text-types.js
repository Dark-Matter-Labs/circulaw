...
export const greenBoxComponent = ({ value }) => (
  <div className='my-10'>
    <div className='bg-green-300 w-full px-8 py-8 rounded-cl'>
...
export const pdfBlockComponentMeasurePage = ({ value }) => {
  ...
  return (
    <div className=''>
      <div className='bg-green-600 rounded-cl'>
        <div className='gradient-pdf p-10 my-10 relative overflow-hidden rounded-cl'>
