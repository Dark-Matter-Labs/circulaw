...
export const greenBoxPTComponent = ({ value }) => {
  ...
  return (
    ...
    <Disclosure className='w-full'>
      {({ open }) => (
        <>
        <Disclosure.Button className={`${open ? 'rounded-t-clSm' : 'rounded-clSm'} text-black-white-800 bg-black-white-250 flex justify-between items-center w-full p-6`}>
      ...
      />
        ...
        <Disclosure.Panel className='bg-black-white-250 px-6 pb-6 rounded-b-clSm'>
          <div>
...
export const smallParaPTComponent = ({ value }) => {
  ...
  return (
    <div className='my-6'>
      <div className='text-black-white-800 bg-black-white-250 rounded-clSm w-full'>
        <h2 className='mobile sm:desktop p-6'>{value.smallParaTitle}</h2>
  ...
  return (
    <div className=''>
      <div className='bg-green-600 rounded-none sm:rounded-cl'>
        <div className='gradient-pdf p-10 my-6 relative overflow-hidden rounded-none sm:rounded-cl'>
