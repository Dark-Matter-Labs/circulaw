...
import {
  ...
  bulletItemComponent,
  numberItemComponent,
  bulletComponentSmallPara,
  numberComponentSmallPara,
} from './portable-text-lists';
import { normalTextComponent, normalTextComponentSmallPara } from './portable-text-blocks';
...
export const smallParaPTComponent = ({ value }) => {
  const smallParaPTComponents = {
    list: {
      bullet: bulletComponentSmallPara,
      number: numberComponentSmallPara,
    },
    listItem: {
      bullet: bulletItemComponent,
      number: numberItemComponent,
    ...
    block: {
      normal: normalTextComponentSmallPara,
    },
    marks: {
