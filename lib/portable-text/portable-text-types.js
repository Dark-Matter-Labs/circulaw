...
export const InlineImageComponent = (props) => {
  console.log(props.value, 'props in inline image component');
  ...
  return (
    <div className='relative my-20 w-full rounded-cl'>
      <Image
        {...imageProps}
...
export const YTComponent = ({ data }) => {
  return (
    <div className='my-[120px] rounded-cl bg-green-100 px-40 py-20'>
