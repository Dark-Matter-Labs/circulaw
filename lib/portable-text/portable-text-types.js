        ...
        {({ open }) => (
          <>
            <Disclosure.Button
              ...
              } text-black-white-800 bg-black-white-250 flex justify-between items-center w-full p-4 sm:p-6`}
            >
            ...
            <Disclosure.Panel className='bg-black-white-250 px-4 pb-4 sm:px-6 sm:pb-6 rounded-b-clSm'>
              <div>
