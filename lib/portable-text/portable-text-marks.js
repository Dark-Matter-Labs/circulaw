...
export const linkComponentGreenBox = ({ children, value }) =>
  value.blank == true ? (
    ...
    <a className='text-green-500 link-base sm:link-lg link-interaction-dark-bg' href={value.href}>
      {children}
    </a>
  );
...
export const linkBGDarkComponent = ({ children, value }) =>
  value.blank == true ? (
    ...
    <a className='link-base sm:link-lg link-interaction-dark-bg' href={value.href}>
      {children}
    </a>
  );
