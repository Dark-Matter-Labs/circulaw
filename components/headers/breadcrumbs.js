  ...
  if (pageType === 'instrument') {
    return (
      <button
        type='button'
        onClick={() => router.back()}
        className='p-2xs-semibold inline-flex h-min flex-row items-center justify-center rounded-clSm bg-green-100 py-1.5 pl-2 pr-3 align-middle text-green-500 hover:text-green-400 focus:text-green-300 focus:ring-2 focus:ring-white active:text-cl-black'
      >
