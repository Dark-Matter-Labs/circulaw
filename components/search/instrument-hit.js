...
export const InstrumentHit = ({ hit }) => {
  return (
    <>
      <article className='hidden sm:block p-4 rounded-cl group hover:shadow-card transition-all duration-100 w-[760px]'>
        <Link
      ...
      <div className='block sm:ml-0 mb-10 sm:mb-8 md:max-w-[760px] p-4 bg-green-50 rounded-cl'>
            <div className='flex justify-start items-center -ml-1'>
              ...
              {hit?.categorie?.includes('beleid') && <Tag classes='bg-green-500 text-gray-100 mr-2'>Beleid</Tag>}
              {hit?.categorie?.includes('inkoop') && <Tag classes='bg-green-500 text-gray-100 mr-2'>Inkoop</Tag>}
              {hit?.categorie?.includes('grondpositie') && (
                <Tag classes='bg-green-500 text-gray-100 mr-2'>Grondpositie</Tag>
              )}
              {hit?.categorie?.includes('subsidie') && (
              ...
              {hit?.categorie?.includes('fiscaal') && <Tag classes='bg-green-500 text-gray-100'>Fiscaal</Tag>}
            </div>
          ...
          <div className='flex flex-row justify-between h-auto py-2'>
            ...
            <div className='flex flex-col justify-center'>
              <div className='p-xs-semibold py-1 text-gray-600'>Invloed</div>
              <div className='flex items-center'>
                <div className='p-xs-semibold text-green-500 bg-green-100 px-1.5 py-1 rounded-cl'>{hit?.juridischInvloed}</div>
              </div>
            </div>
          </div>
