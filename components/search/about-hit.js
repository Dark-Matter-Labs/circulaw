  ...
  return (
    <>
      <Link href={`/over/${hit.slug}`} onClick={() => sessionStorage.clear()} className='group'>
        <article className='group flex flex-col h-full bg-gray-100 rounded-cl'>
        ...
        <div className='-z-10 absolute  gradient-600 h-[20px] -translate-y-[20px] group-hover:-translate-y-[10px] w-full rounded-b-cl transition-all duration-300'></div>
