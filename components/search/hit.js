...
export const Hit = ({ hit }) => {
  ...
  return (
    <article>
       <Link
          href={`/${hit.transitionAgenda}/${hit.thema}/instrumenten/${hit.slug}`}
        >
      ...
      <div className='hidden sm:block'>
        <div
          className='border-y border-gray-300 h-auto flex flex-row gap-x-4 grow-0 items-center justify-self-center max-w-[870px]'
        >
