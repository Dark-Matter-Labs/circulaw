    ...
    <nav className='space-y-1 sticky top-64' aria-label='Sidebar'>
      ...
      {slugs?.map((slug) => (
        <a
          ...
          className={`${slug.slug === currentSlug ? 'text-black-white-800' : 'text-green-500 hover:bg-gray-50 hover:text-gray-900' } flex items-center px-3 py-2 breadcrumb bg-black-white-200`}
