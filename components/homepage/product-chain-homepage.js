            ...
            <li className='group relative flex h-[400px] w-auto max-w-[250px] flex-col justify-between overflow-hidden rounded-cl'>
              ...
              <div className='absolute bottom-0 left-0 flex h-[72%] flex-col justify-between rounded-b-cl bg-cl-black px-6 pb-4 pt-5 transition-all duration-300 group-hover:translate-y-[20px] group-hover:bg-green-500'>
                <div className='flex h-[180px] origin-center flex-col justify-center divide-y-[0.5px] divide-green-500 transition-all duration-300 group-hover:-translate-y-[20px] group-hover:divide-gray-100'>
                  ...
                  <div className='p-base h-1/2 pt-3 text-green-200 transition duration-300'>
                    {chain.cardText}
                  </div>
                </div>
                <div className='grid justify-items-end transition-all duration-300 group-hover:-translate-y-[20px]'>
                  <div className='flex h-10 w-10 items-center justify-center self-end rounded-full border-2 border-white bg-transparent text-white focus:bg-green-100 focus:outline-none focus:ring-2 focus:ring-white active:bg-green-400 group-hover:border-green-200 group-hover:bg-green-200 group-hover:text-green-500'>
          ...
          <li key={id} className='mb-6 block h-32 w-full rounded-cl bg-cl-black shadow sm:hidden'>
            <Link href={`/${chain.slug}`} className='h-full w-full'>
              <div className='flex items-center justify-between'>
                ...
                <div className='ml-4 w-full max-w-[170px] break-words text-gray-100'>
