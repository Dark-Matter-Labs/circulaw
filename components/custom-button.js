const buttonColors = {
  ...
  whiteShaddow:
    'w-full sm:w-auto border-black-white-200 bg-black-white-200 drop-shadow-lg text-green-600 hover:bg-green-200 hover:border-green-200 hover:duration-150 transition ease-in-out',
};
