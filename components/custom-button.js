const buttonColors = {
  home: 'bg-black-white-100 hover:bg-green-200 text-green-600 shadow-md active:bg-green-300 focus:outline-none focus:bg-green-100 focus:ring-2 focus:ring-white rounded-full',
  whiteBackground:
  ...
  greenBackground:
    'bg-green-600 hover:bg-green-200 hover:text-green-600 text-black-white-100 active:bg-green-800 active:text-black-white-100 focus:outline-none focus:ring-2 focus:ring-white rounded-full',
  greenBackgroundLessRound:
    'bg-green-600 hover:bg-green-200 hover:text-green-600 text-black-white-100 active:bg-green-800 active:text-black-white-100 focus:outline-none focus:ring-2 focus:ring-white rounded-[10px]',
};
