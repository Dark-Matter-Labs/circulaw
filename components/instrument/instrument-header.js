          ...
          <div className='mb-6 h-auto'>
            <div className='flex w-full'>
              ...
              {data?.beleid === true && data?.themaType === 'thema' && (
                ...
                >
                  <Tag classes='bg-green-400 text-cl-black hover:text-gray-100 hover:border hover:border-gray-100 hover:bg-transparent active:border-green-400 active:text-green-400 focus:text-green-100 focus:right-2 focus:ring-white mr-2'>
                    Beleid
                  </Tag>
                </Link>
              )}
