    ...
    return(
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 '>
          ...
          <div className='container mb-2 sm:mb-20 mt-10'>
            ...
            <div>
              <h2 className='max-w-0 leading-6 pb-1 pl-1 mobile sm:main lowercase first-letter:uppercase'>{props.casus} stimuleren</h2>
            </div>
          </div>
              ...
              {numberOfLaws === 0 && (
                <div>
                  <span className='font-manrope text-lg sm:text-xl'>
                    <b>0</b> maatregelen gevonden voor <b>{searchValue}</b> in <b className='inline-block lowercase first-letter:uppercase'>{props.casus}</b>{' '}
                  </span>
                </div>
              )}
