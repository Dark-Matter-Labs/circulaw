...
export default function AreaPlanningLayout() {
  const target = useRef();
        ...
        <div className='flex flex-col'>
          ...
          <div className='flex max-w-[700px] flex-col gap-y-4'>
            ...
            <p>
              ...
              <span className='p-base-semibold'>&apos;Voorfase&apos;</span> aan het proces toe. In
              deze voorfase onderzoek je welke informatiestukken je moet lezen, welke collega&apos;s
              je moet benaderen en bij welke belangrijke momenten van het gebiedsontwikkelingsproces
                  ...
                  <div className='flex flex-col gap-8 py-6'>
                    <ul className='ml-6 flex list-outside list-disc flex-col gap-y-4'>
                      <li>
                        ...
                        betrokken kunnen en willen worden en of er (betere) alternatieven zijn. Aan
                        het eind van de verkenningsfase moet minimaal een plan zijn opgesteld met de
                        projectdoelen en rolverdeling.
                      </li>
                      <li>
                        <span className='p-base-semibold'>Haalbaarheid: </span>in de
                        haalbaarheidsfase wordt er &apos;gerekend en getekend&apos;. Dit betekent
                        dat een of meerdere ontwerpen worden ontwikkeld en er wordt gerekend aan de
                        businesscase voor de gebiedsontwikkeling. Ook moeten de beleidsmatige,
                      ...
                      <li>
                        ...
                        realisatiefase. Denk hierbij aan het uitwerken van het definitieve ontwerp,
                        het verkrijgen van de benodigde omgevingsvergunningen en het sluiten van de
                      ...
                      <li>
                        ...
                        in de exploitatiefase worden de gebouwen opgeleverd en wordt het beheer van
                        het openbaar terrein overgedragen.
                      </li>
                      <li>
          ...
          <p className='p-base mb-10 max-w-[700px] md:mb-20'>
            ...
            instrument op het juiste moment inzet, en zo circulariteit goed meeneemt. Ook houtbouw
            kan op deze manier een stevige plek krijgen binnen gebiedsontwikkeling.
          </p>
          ...
          <div className='mb-10 max-w-[700px]'>
            ...
            <p className='mb-6 mr-6'>
              ...
              <span className='p-base-semibold'>35 juridische instrumenten</span> in kaart gebracht.
              Die instrumenten winnen aan kracht als je al in de voorfase de juiste maatregelen
              treft. Die voorfase bevat een aantal{' '}
          ...
          <div className='mb-10 flex max-w-[750px] flex-col sm:mb-20'>
            ...
            <p className='max-w-[700px]'>
              ...
              hand zetten. Daarbij heb je natuurlijk{' '}
          ...
          <div className='max-w-[700px]' id='contact'>
            ...
            <ul className='ml-6 flex list-outside list-disc flex-col'>
              ...
              <li>
                <span className='p-base-semibold'>Implementatietrajecten </span>voor een succesvolle
                toepassing van juridische instrumenten.
              </li>
              <li>
          ...
          <div className='mt-6'>
            <div
              className='flex max-w-[445px] flex-col gap-y-6 rounded-cl bg-green-50 p-4'
              ref={target}
            >
              <div>
