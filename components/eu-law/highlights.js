...
export default function Highlights({ law }) {
  if (law === 'CSRD') {
    ...
    return (
      <div className='global-margin'>
        <h2 className='heading-3xl-semibold mb-4 text-cl-black'>
          Critical Raw Materials Act highlights
        </h2>
        ...
        <p className='my-16 max-w-xl'>De tussendoelen van de Critical Raw Materials Act</p>
        <div className='mb-6 grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-10 lgNav:grid-cols-3'>
          <HighlightCard
          ...
          <HighlightCard
            ...
            icon={crma4}
          />{' '}
          <HighlightCard text='Het vergroten van de paraatheid' icon={crma5} />{' '}
          <HighlightCard
