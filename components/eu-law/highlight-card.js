...
export default function HighlightCard({text, number, circleText, icon}) {
    return (
        ...
        <div className="w-full flex items-center justify-center text-center">
                <div className="p-base-semibold mb-4">
                {text}
                </div>
            </div>
            <div className="">
                ...
                <div className="text-center p-base-semibold text-green-600 max-w-[90px]">{circleText}</div></>}
                {icon && 
                <Image src ={icon} alt={text} className='w-[75px] h-[75px]' />
                }
                </div>
            </div>
