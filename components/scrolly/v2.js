...
export default function V2() {
  ...
  useEffect(() => {
    ...
    if (scrollPosition < 1950) {
      setActiveNav(0);
    } else if (scrollPosition > 1950 && scrollPosition < 3900) {
      setActiveNav(1);
    } else if (scrollPosition > 3900 && scrollPosition < 5850) {
      setActiveNav(2);
    ...
    if (scrollPosition < 650) {
      ...
      setActiveContent('c4');
    } else if (scrollPosition > 2600 && scrollPosition < 3250) {
      setActiveContent('c5');
    } else if (scrollPosition > 3250 && scrollPosition < 3900) {
      setActiveContent('c6');
    } 
  ...
  const thresholdStart = 3900; // start the transition
  const thresholdEnd = 4300; // complete the transition
  ...
  const transformStyle = {
   ...
   const coneHeight = Math.min((scrollPosition - 4300) / 5, maxHeight);
  ...
  return (
    <>
      ...
      <div className='sticky top-44 mt-10 flex items-start justify-center w-full'>
        ...
        {animationStage === 0
        ?
        <div className='flex items-center justify-center w-[635px] h-[635px]' style={{ perspective: '1000px' }}>
