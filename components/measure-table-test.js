        ...
        <table className='table-fixed w-full mt-5'>
          <tbody>
            ...
            <tr className='my-10 border-b-2'>
              ...
              <td className='w-1/2 font-manrope text-base font-bold first-letter:uppercase'>{data.measure?.citeertitel}</td>
            </tr>
            <tr className='my-10 border-b-2'>
            ...
            <tr className='my-10 border-b-2'>
              ...
              <td className='w-1/2 font-manrope text-base font-bold'>
                {data.measure?.governmentLevel.map((level) => (
                    <span key={level} className ='capitalize'>{level}{' '}
                    {data.measure?.governmentLevel.slice(-1)[0] !== level &&
                    <span>-{' '}</span>
                    }
                    </span>
                    ))}
