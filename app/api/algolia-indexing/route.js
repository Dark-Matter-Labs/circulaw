...
*[_type in ['euEuropeTab', 'euCircularEconomyTab', 'euLocalTab', 'euLaw'] && !(_id in path('drafts.**'))] {
    ...
    'slug': coalesce(euLawReference->slug.current, slug.current),
     introText,
    'eu1Content': array::join(string::split((pt::text(europeContent[0].content)), "")[0..5000], ""), 
    'eu2Content': array::join(string::split((pt::text(europeContent[2].content)), "")[0..5000], ""),
    'eu3Content': array::join(string::split((pt::text(europeContent[3].content)), "")[0..5000], ""), 
    'eu4Content': array::join(string::split((pt::text(europeContent[4].content)), "")[0..5000], ""), 
    'eu5Content': array::join(string::split((pt::text(europeContent[5].content)), "")[0..5000], ""), 
    'eu6Content': array::join(string::split((pt::text(europeContent[6].content)), "")[0..5000], ""), 
    'eu7Content': array::join(string::split((pt::text(europeContent[7].content)), "")[0..5000], ""), 
    'eu8Content': array::join(string::split((pt::text(europeContent[8].content)), "")[0..5000], ""), 
