...
export default function Beta() {
  return (
    <div className='global-margin my-20'>
      <h1 className='heading-2xl-semibold sm:heading-5xl-semibold pb-4 text-gray-800'>
        Betaversie CircuLaw
      </h1>
      <p className='p-base max-w-2xl pb-6 text-gray-800'>
      ...
      <span className='p-base max-w-2xl text-gray-800'>op deze Betaversie</span>
    </div>
  );
}
