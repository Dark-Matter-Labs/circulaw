...
export default {
    ...
    fields: [
        ...
        }, 
        {
            ...
            type: 'string',
            validation: (Rule) => Rule.required(),
            description: 'This will be displayed above the 3 cards leading to the overviews on the Thema page',
            group: 'editableContent',
        }, 
        {
            ...
            type: 'string',            
            validation: (Rule) => Rule.required(),
            description: 'This will be displayed about the legal instruments that are featured on the Thema page (Uitgelicht: X ...) start from after the number',
            group: 'editableContent',
        },
        {
