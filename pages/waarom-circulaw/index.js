      ...
      <div className='grid grid-col-1 sm:grid-cols-3'>
        <div className='mx-7 sm:mx-20 my-20 col-span-2 text-black1'>
          ...
          <p className='body-text-mobile sm:body-text max-w-4xl'>
            ...
            essentieel. In Nederland hebben we nog een lange weg te gaan. De wet- en regelgeving die
            hierbij kan helpen is complex, ontoegankelijk, moeilijk vindbaar, onbekend. Gevolg: er
            worden oplossingen gezocht die vaak te vrijblijvend zijn. CircuLaw laat daarom zien waar
            en hoe regelgeving mogelijkheden biedt om circulaire doelen te halen en zo bij te dragen
          ...
          <p className='body-text-mobile sm:body-text max-w-4xl pb-5'>
            ...
            die vaak onbenut blijven. Want regelgeving is complex. Daardoor is het voor
            beleidsmakers vrijwel onmogelijk om een breed inzicht en overzicht te krijgen van die
            mogelijkheden. Daar komt nog eens bij dat juristen binnen organisaties vaak sterk
            gespecialiseerd zijn, waardoor het voor beleidsmakers lastig is om een overzicht te
            krijgen en te weten welke overheidslaag welke bevoegdheden heeft. CircuLaw maakt daarom
            transparant waar en hoe regelgeving mogelijkheden biedt om circulair beleid te maken.
          </p>
        </div>
