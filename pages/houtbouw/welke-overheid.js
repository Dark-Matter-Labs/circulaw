  ...
  return (
    <Layout>
      <div className='mx-7 max-w-7xl lg:mx-auto my-20 max-w-2xl'>
        ...
        <p className='body-text-mobile sm:body-text text-black1 pb-6'>
          Provincies kunnen houtbouw integreren in hun omgevingsverordening door de houtopstanden in
          het gebied te vergroten. Het stellen van omgevingswaarden kan hierbij helpen
        </p>
        <p className='body-text-mobile sm:body-text text-black1 pb-6'>
          Gemeenten kunnen ook veel doen. Zo kunnen gemeenten regels stellen over
          sloopwerkzaamheden, afvalstoffen en recycling. Daarnaast kan houtbouw opgenomen worden in
          het omgevingsplan om de vergunningverlening hierop aan te passen. Omgevingswaarden kunnen
          hierbij een rol spelen.
        </p>
        <p className='body-text-mobile sm:body-text text-black1'>
          Gemeenten, provincies en Rijk hebben ook nog gedeelde bevoegdheden: aanbestedingen spelen
          hierbij de grootste rol. Het vergroten van het aandeel publieke grond zorgt ervoor dat
          circulaire eisen kunnen worden gesteld bij de uitgifte van die gronden. De omgevingsvisie
          is voor alle overheden belangrijk omdat hier de beleidsdoelen voor houtbouw in kunnen
