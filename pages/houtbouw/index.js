...
export default function Houtbouw() {
  ...
  return (
    <Layout>
      {/* TODO: this page and Circularie windmill index page are very similar and basic layout should be combined */} 
            ...
            <div className='border-b border-grey1 pb-10'>
              <div className='grid grid-cols-1 sm:grid-cols-3 items-center'>
                <div className='col-span-2'>
                  <h2 className='pt-10 mobile sm:main'>36 Houtbouwmaatregelen</h2>
            ...
            <div className='border-b border-grey1 pb-10'>
              <div className='grid grid-cols-1 sm:grid-cols-3 items-center'>
                <div className='col-span-2'>
                  ...
                  <p className='body-text-mobile sm:body-text py-5 max-w-2xl'>
                    CircuLaw heeft 36 maatregelen gedefinieerd die je kunt inzetten om houtbouw te
