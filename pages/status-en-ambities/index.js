      ...
      <div className='grid grid-cols-1 sm:grid-cols-3'>
        <div className='mx-7 sm:mx-20 my-20 col-span-2 text-black1'>
          ...
          <p className='body-text-mobile sm:body-text max-w-4xl'>
            ...
            <ul className='list-disc pl-6'>
              <li>
                ...
                maatregelen voor de thema’s houtbouw (44 maatregelen) en circulaire windmolens (8
                maatregelen){' '}
              </li>
          ...
          <p className='body-text-mobile sm:body-text max-w-4xl pb-5'>
            ...
            transitie steeds verder gedekt. Dit heeft nog een groot voordeel: overheden hoeven
            straks niet telkens opnieuw apart losse opdrachten te verlenen voor onderzoek naar
            mogelijkheden in regelgeving. Hiermee wordt potentieel een hoop geld bespaard, en wordt
