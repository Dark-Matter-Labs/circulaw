    ...
    <Layout>
      <div className='global-margin  pb-8 text-black1'>
        <div className='max-w-4xl'>
          ...
          <h2 className='mobile sm:main pb-2'>Waarom CircuLaw?</h2>
          <p className='body-text-mobile sm:body-text pb-10'>
            Uit recente adviezen van Planbureau voor de Leefomgeving en de Reflectiegroep Circulaire
            Economie blijkt dat meer drang en dwang nodig is om de circulaire transitie te
            versnellen. In de praktijk blijkt echter dat beleidsmakers bij provincies en gemeenten
            vaak niet weten welke juridische instrumenten ze tot hun beschikking hebben, en hoe ze
            deze moeten toepassen. Uit breed Nederlands onderzoek blijkt dat slechts 8% van de inzet
            van beleidsinstrumenten door decentrale overheden wet- en regelgeving betreft. CircuLaw
            wil hier verandering in brengen door beleidsmakers in Nederland te helpen, zodat zij
            vaker met juridische maatregelen aan de slag gaan.
          </p>

          <h2 className='mobile sm:main pb-2'>Voor wie is CircuLaw bedoeld?</h2>
          ...
          <h2 className='mobile sm:main pb-2'>Wat zijn de &apos;maatregelen&apos; in CircuLaw?</h2>
          ...
          <h2 className='mobile sm:main pb-2'>
            Ik wil aan de slag met een maatregel, maar weet niet goed hoe dat moet. <br />Kan CircuLaw
            helpen?
          </h2>

          <p className='body-text-mobile sm:body-text pb-10'>
            CircuLaw maakt de beschikbare maatregelen inzichtelijk die kunnen bijdragen aan het
            realiseren van de operationele doelen van een circulaire casus, zoals houtbouw.
            Succesvol toegepaste maatregelen worden geanalyseerd en in stappenplannen uitgewerkt,
            zodat andere gemeenten en provincies die kunnen overnemen. Ook worden interactieve
            handleidingen voor toepassing van maatregelen ontwikkeld.
          </p>

          <h2 className='mobile sm:main pb-10 pb-2'>
          ...
          <h2 className='mobile sm:main pb-2'>Hoe wordt CircuLaw betaald?</h2>

          <p className='body-text-mobile sm:body-text pb-10'>
            De ontwikkeling van CircuLaw wordt betaald door Gemeente Amsterdam, Climate-KIC,
            Provincie Noord-Holland, Provincie Flevoland, RVO, de Transitieagenda Circulaire
            Bouweconomie, Dark Matter Labs en Laudes Built By Nature. In de toekomst wordt een
            exploitatiemodel ontwikkeld waarbij het uitgangspunt is dat alle inhoud open source is
            en gratis voor iedereen beschikbaar.
          </p>
