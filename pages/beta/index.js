  ...
  return (
    <Layout title='CircuLaw - Beta'>
      <div className='global-margin my-20'>
        <h1 className='mobile sm:desktop text-gray-800 pb-4'>Betaversie CircuLaw</h1>
        <p className=' p-lg text-gray-800 pb-6  max-w-2xl'>
        ...
        <span className=' p-lg text-gray-800 max-w-2xl'>op deze Betaversie</span>
      </div>
    </Layout>
  );
}
