      ...
      <div className='grid grid-cols-1 sm:grid-cols-3'>
        <div className='mx-7 sm:mx-20 my-20 col-span-2 text-black1'>
          ...
          <p className='body-text-mobile sm:body-text max-w-4xl pb-10'>
            ...
            more democratic, distributed and sustainable future.” DML is mede-initiator van
            ...
            expertise op het gebied van transitiemanagement, strategisch ontwerp, interdisciplinaire
          ...
          <p className='body-text-mobile sm:body-text max-w-4xl pb-10'>
            ...
            Instituut voor innovatie en technologie identificeert en ondersteunt Climate-KIC
            innovatie die de samenleving helpt om de klimaatverandering te verminderen en zich
            hieraan aan te passen. CircuLaw heeft in de vroege ontwikkelfase deelgenomen aan
            Climate-KICs Deep Demonstrations Programma, en heeft vanuit dit programma financiering
            en kennis ontvangen.
          </p>
          ...
          <p className='body-text-mobile sm:body-text max-w-4xl pb-10'>
            ...
            dan niet meer verbrand of gestort maar gebruikt als grondstof voor nieuwe materialen en
            producten. Het delven van nieuwe grondstoffen wordt dan tot het minimum beperkt. Om dit
            te bereiken, wil de provincie circulair ondernemen én het circulair maken van
          ...
          <p className='body-text-mobile sm:body-text max-w-4xl pb-10'>
            ...
            ondernemers weg te nemen en door een goede beleidsvisie voor de lange termijn te maken,
            waar ondernemers op kunnen investeren. Vanuit het{' '}
            <a
          ...
          <p className='body-text-mobile sm:body-text max-w-4xl pb-10'>
            ...
            dragen inhoudelijk bij aan de ontwikkeling van CircuLaw. Het gaat daarbij om kennis over
            wetgeving, technologie en digitalisering, en om inhoudelijke kennis op het gebied van
            belastingen en duurzaamheid. De nieuwe kennis die binnen CircuLaw wordt ontwikkeld,
            wordt vervolgens gebruikt in het het universitaire onderwijs.
          </p>
          ...
          <p className='body-text-mobile sm:body-text max-w-4xl pb-10'>
            ...
            toepassing van nieuwe wetenschappelijke inzichten in de stad. AMS Institute draagt
            vanuit kennis, middelen en netwerk bij aan de ontwikkeling van CircuLaw.
          </p>
          ...
          <p className='body-text-mobile sm:body-text max-w-4xl pb-10'>
            ...
            hierbij? Zijn algoritmen een vloek of een zegen? Hoe bereiken mens en digitalisering een
            gezond evenwicht? Het VU-onderzoek werpt voortdurend een nieuw licht op de vele facetten
            van digitalisering. Vanuit het VU Center for Public Contract Law and Governance wordt
            binnen het project Wetgeving en Digitalisering bijgedragen aan CircuLaw.
          </p>
          ...
          <p className='body-text-mobile sm:body-text max-w-4xl pb-10'>
            ...
            van producten, mogelijkheid tot reparatie en hergebruik van producten en om het
            stimuleren van het gebruik van hernieuwbare grondstoffen. Met NEN wordt verkend hoe NEN
            normen concreet kunnen bijdragen aan het versnellen van de circulaire transitie. Ook
            wordt met het{' '}
          ...
          <p className='body-text-mobile sm:body-text max-w-4xl pb-10'>
            ...
            beleid zodat we het wet- en regelgevingsstelsel nog beter in dienst kunnen stellen van
