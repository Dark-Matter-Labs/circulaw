...
export default function Contact() {
  ...
  return (
    <Layout>
      <div className="mx-20">
        <h1 className="text-green1 pt-10">Contact</h1>
        <p className="body-text py-10 max-w-2xl">
          Heb je een vraag of opmerking over de site of het project? Vul dan je
          gegevens in. Na verzending nemen we zo snel mogelijk contact met je
          op.
        </p>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <p className="text-base text-gray-500">
                    ...
                    <a
                      href="#"
                      className="font-medium text-greenLink font-manrope"
                    >
                      privacy verklaring
                    </a>
                  </p>
