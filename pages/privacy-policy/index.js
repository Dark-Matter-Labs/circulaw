  ...
  return (
    <Layout>
      <div className='global-margin my-20 max-w-2xl text-black1'>
        ...
        <div className='body-text-mobile sm:body-text pb-10'>
        ...
        <p className='body-text-mobile sm:body-text pb-10'>Dit doen wij nooit.</p>
        <h2 className='mobile sm:main py-2'>
        ...
        <p className='body-text-mobile sm:body-text pb-10'>
          Als je het niet eens zijn met de manier waarop MVO Nederland omgaat met je
