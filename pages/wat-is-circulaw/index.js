    ...
    <Layout>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-3'>
        <div className='mx-7 sm:mx-20 my-20 col-span-2 text-black1'>
          ...
          <p className='body-text-mobile sm:body-text max-w-4xl pb-4'>
            CircuLaw is een service waarmee we beleidsmakers, transitiemanagers en juristen helpen
            meer en beter gebruik te maken van regelgeving om de circulaire economie te bevorderen.
            In een tool bieden we hen per circulaire productgroep op basis van brede wetsanalyses
            beleidsmaatregelen aan. Ook bieden we hulp bij de toepassing van die maatregelen met een
            praktische leidraad en praktijkvoorbeelden. Maar CircuLaw is ambitieus. Door stap voor
            stap uit te breiden willen we uiteindelijk ook vergunningverleners, toezichthouders en
          ...
          <h2 className='mobile sm:main'>Van wet-en regelgeving naar praktijk</h2>
          <p className='body-text-mobile sm:body-text max-w-4xl pb-5'>
            ...
            praktijk. Ter inspiratie, én als middel om beleidsmedewerker op weg te helpen. Daarnaast
            presenteert CircuLaw ook instructies aan beleidsmedewerkers hoe zij binnen hun provincie
            of gemeente maatregelen kunnen toepassen. Hierbij worden ook suggesties gedaan voor
            teksten, waarden of verwijzingen naar keurmerken, die als basis kunnen dienen voor het
            stellen van eisen. Ook worden waar mogelijk modelteksten aangeboden, die bijvoorbeeld
            één op één verwerkt kunnen worden in een verordening.
          </p>
          ...
          <p className='body-text-mobile sm:body-text max-w-4xl'>
            ...
            instrumentenmix kan leiden tot wat we ‘hefbomen’ noemen in de transitie. Het combineren
            en inzetten van maatregelen van verschillende rechtsgebieden, bijvoorbeeld publiek en
            privaat, kan een versterkend effect hebben.
          </p>
          <br />
          ...
          <p className='body-text-mobile sm:body-text max-w-4xl'>
            ...
            Toepasbaar vanuit de doelstellingen van een circulaire productgroep. CircuLaw maakt het
            mogelijk om gelijk te zien welke mogelijkheden een specifieke wet biedt voor het
          ...
          <p className='body-text-mobile sm:body-text max-w-4xl pb-10'>
            ...
            biedt voor het versnellen van de circulaire transitie, en er mee aan de slag te gaan. De
            wet als service.
          </p>
          <h2 className='mobile sm:main'>Uniformiteit in decentrale uitvoering </h2>
          <p className='body-text-mobile sm:body-text max-w-4xl'>
